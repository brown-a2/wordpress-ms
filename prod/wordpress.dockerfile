...
RUN set -eux; \
    ...
    echo "https://downloads.mariadb.com/MariaDB/mariadb-10.11/repo/alpine" >> /etc/apk/repositories && \
    apk add --no-cache --repository="https://downloads.mariadb.com/MariaDB/mariadb-10.11/repo/alpine" mariadb mariadb-client && \
